<script>
  ...
  let activeTab = 'details'; // 'details', 'comments', or 'documents'
  ...
  const mockData = {
    ...
    businessData: [ // Datos completos para el formulario
  ...
  // Filtra la línea de tiempo para mostrar solo tareas completadas o en progreso
  ...
  // Calcula los indicadores de progreso
  const totalSteps = mockData.timeline.length;
